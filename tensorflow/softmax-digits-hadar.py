...
#    record_defaults = [[0]]+[[""]]*25
    ...
    topR,topG,topB,medR,medG,medB,lowR,lowG,lowB,lTopR,lTopG,lTopB,lBotR,lBotG,lBotB,rTopR,rTopG,rTopB,rBotR,rBotG,rBotB,BgR,BgG,BgB,digit = tf.decode_csv(csv_row, record_defaults=record_defaults)
