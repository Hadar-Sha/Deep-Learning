...
MODE = 'file' # or 'folder', if you choose a plain text file (see above).
#DATASET_PATH = 'C:/Users/H/Documents/Haifa Univ/Thesis/deep learning/deep-input/small/data/data-deep-meta.txt' # the dataset file or root folder path.
DATASET_PATH ='C:/Users/H/coding/Anaconda/Hadar/Thesis/data/data/data-deep-meta.txt'
# Image Parameters
N_CLASSES = 10 # CHANGE HERE, total number of classes
IMG_HEIGHT = 27 # CHANGE HERE, the image height to be resized to
IMG_WIDTH = 17 # CHANGE HERE, the image width to be resized to
