...
SAMPLE_DATA = [252,252,252,3,3,3,252,252,252,252,252,252,252,252,252,252,252,252,252,252,252,3,3,3]
SAMPLE_LABEL = [0]
...
def convert_int_to_one_hot_vector(label, num_of_classes):
    ...
    if len(list(label.size())) < 3:
        ...
        # one_hot_vector = one_hot_vector.type(torch.IntTensor)
...
def mse_loss_fn(outputs, real):
    ...
    return mse_criterion(outputs, real)
