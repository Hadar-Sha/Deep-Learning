...
# Hyper Parameters 
input_size = 24
hidden_size = 98 #94 #90 #100 #128  # 120 #250 #500 #50 #80 #110
num_classes = 10  #11    # should be 11 with experiment data ( no digit is the extra option)
num_epochs = 40000  #30000 #10000 #50000 # was 2000
batch_size = 100  #120 #60
learning_rate = 0.01  #0.005 #0.01  #0.015  # 0.005
momentum_val = 0.1  #0.9999

# training_data_path = './data-with-grayscale/train/exp-data-train.csv'
# dev_data_path = './data-with-grayscale/dev/exp-data-dev.csv'
